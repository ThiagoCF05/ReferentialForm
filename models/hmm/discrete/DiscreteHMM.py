...
from models.hmm._BaseHMM import _BaseHMM
import numpy
...
class DiscreteHMM(_BaseHMM):
    ...
    def __init__(self,n,m,A=None,B=None,pi=None,init_type='uniform',precision=numpy.double,verbose=False,scaled=True):
        '''
        ...
        '''
        _BaseHMM.__init__(self,n,m,precision,verbose,scaled) #@UndefinedVariable
