...
from models.hmm.continuous.GMHMM import GMHMM
...
def test_discrete():
    ...
    ob5 = (2,1,2,1,0,1,2,2,1,2,0,0,0,1,1,2,1,2,0)
    print "Doing Baum-welch"
    ...
    btmp = numpy.random.random_sample((4, 3))
    ...
    hmm2 = DiscreteHMM(4,3,a,b,pi,init_type='user',precision=numpy.longdouble,verbose=True)
    hmm2.train(numpy.array(ob5*10),10)
    print "Pi",hmm2.pi
    print "A",hmm2.A
    print "B", hmm2.B
